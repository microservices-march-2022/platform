...
[Code of Conduct](https://github.com/microservices-march/platform/blob/main/CODE_OF_CONDUCT.md)

## Getting Started

Follow our [Installation Guide](https://github.com/microservices-march/platform/blob/main/README.md#Installation) to get this repository up and running.
...
* Fill in [our pull request template](https://github.com/microservices-march/platform/blob/main/.github/pull_request_template.md).
